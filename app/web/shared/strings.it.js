...
window.BancoStrings.it = {
  ...
  "harness.prompt_summary_edited": "il prompt come inviato — modificato a mano",
  "harness.run": "Esegui",
  ...
  "harness.reset_run": "Azzera questo beat",
  "harness.beats_show_all": "mostra anche le {count} non eseguibili",
  "harness.beats_show_runnable": "mostra solo quelle eseguibili",
  ...
  "harness.gear_title": "fonti del modello per questo beat",
  "harness.gear_loading": "leggo le fonti configurate…",
  "harness.gear_none": "nessuna fonte configurata da scegliere",
  "harness.gear_default": "come da profilo",
  "harness.gear_think_off": "nessun ragionamento",
  "harness.gear_note": "Vale per la prossima esecuzione. Un parametro scritto nel run block vince comunque: e' cio' che il beat insegna.",
  "harness.open_prompt": "Apri e modifica",
  "harness.prompt_edited": "modificato a mano — vale per la prossima esecuzione",
  "harness.viewer_close": "Torna alla panoramica",
  "harness.viewer_bigger": "piu' grande",
  "harness.viewer_smaller": "piu' piccolo",
  "harness.zoom_pane": "apri a tutta pagina",
  "harness.document_loading": "apro il documento…",
  "harness.document_failed": "impossibile aprire il documento: {error}",
