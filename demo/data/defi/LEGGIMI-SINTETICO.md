# Dati sintetici per la lezione — Servizio Revisione e Rilascio Contratti
...
| `rilasci/` | 12 schede di rilascio in PDF | M4 — compito su cartella |
...
La scheda `avvelenata/rilascio-013.pdf` contiene un'istruzione nascosta
...
Rigenerare con: `python generate.py --settore defi` (stesso seed → stessi
documenti).
