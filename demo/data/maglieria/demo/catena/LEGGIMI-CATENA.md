...
Riga **5** — `SPEC-2026-005`: la classe è abbassata di un livello rispetto a `_perito/ground-truth.csv`, che dice `SP-5`. Nessun contrassegno la segnala. È il fallimento voluto n. 2 della DEMO-CHECKLIST: va colto in pubblico aprendo il documento di origine accanto alla tabella.

## I valori veri del record di D1

- modulo interessato e versione in esercizio: `Avanzamento di reparto v3.6`
- codice cliente: `CLI-003`
- tempo standard della fase: `19,30`
- classe di specifica: `SP-4`
