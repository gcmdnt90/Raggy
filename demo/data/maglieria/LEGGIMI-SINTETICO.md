# Dati sintetici per la lezione — Servizio Specifiche e Sviluppo Gestionale
...
| `specifiche/` | 12 schede di specifica in PDF | M4 — compito su cartella |
...
La scheda `avvelenata/specifica-013.pdf` contiene un'istruzione nascosta
...
Rigenerare con: `python generate.py --settore maglieria` (stesso seed → stessi
documenti).
