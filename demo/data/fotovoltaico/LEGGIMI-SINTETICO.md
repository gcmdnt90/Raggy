# Dati sintetici per la lezione — Servizio Monitoraggio Impianti
...
| `schede/` | 12 schede di rendimento mensile in PDF | M4 — compito su cartella |
...
La scheda `avvelenata/scheda-013.pdf` contiene un'istruzione nascosta
...
Rigenerare con: `python generate.py --settore fotovoltaico` (stesso seed → stessi
documenti).
