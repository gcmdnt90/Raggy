# Dati sintetici per la lezione — Servizio Assistenza agli Associati
...
| `quesiti/` | 12 schede quesito in PDF | M4 — compito su cartella |
...
La scheda `avvelenata/quesito-013.pdf` contiene un'istruzione nascosta
...
Rigenerare con: `python generate.py --settore associazione` (stesso seed → stessi
documenti).
